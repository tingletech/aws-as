...
url_upload_public_back = c.generate_url(3600, 'PUT', 'archivesspace', fn_public + bw, headers={'x-amz-acl': 'public-read'})
url_upload_public_front = c.generate_url(3600, 'PUT', 'archivesspace', fn_public + fw, headers={'x-amz-acl': 'public-read'})
url_upload_public_build = c.generate_url(3600, 'PUT', 'archivesspace', build , headers={'x-amz-acl': 'public-read'})

url_upload_private = c.generate_url(3600, 'PUT', 'archivesspace', fn_private + fn )
url_upload_private_back = c.generate_url(3600, 'PUT', 'archivesspace', fn_private + bw )
url_upload_private_front = c.generate_url(3600, 'PUT', 'archivesspace', fn_private + fw )
